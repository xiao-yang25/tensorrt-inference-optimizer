...
FP16_ENGINE="${ROOT_DIR}/engine/bevdet_fp16.engine"
INT8_ENGINE="${ROOT_DIR}/engine/bevdet_int8.engine"
CALIB_CACHE="${ROOT_DIR}/engine/calib.cache"
REPORT_JSON="${ROOT_DIR}/reports/int8_fp16_report.json"
...
mkdir -p "${ROOT_DIR}/engine" "${ROOT_DIR}/reports"
